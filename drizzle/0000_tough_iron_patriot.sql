...
CREATE TYPE "public"."order_status" AS ENUM('created', 'accepted', 'preparing', 'ready', 'delivering', 'delivered', 'cancelled');--> statement-breakpoint
...
CREATE UNIQUE INDEX "customers_email_unique" ON "customers" USING btree ("email");